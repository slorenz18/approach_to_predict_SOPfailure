...
* For EHL: "pressure_EHL _ {Hertzian Pressure} _ {Hertzian half-contact width} _ {Roughness Frequency}.tif" 
* For Sym: "pressure_SYM _ {Hertzian Pressure} _ {Hertzian half-contact width} _ {Roughness Frequency}.tif"
